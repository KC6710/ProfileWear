...
class Ocme3000 extends Migration {
	...
	public function up() {		
		...
		if( ! Schema::hasTable('ocme_filter_condition') ) {
			try {
				Schema::create('ocme_filter_condition', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_filter_grid') ) {
			try {
				Schema::create('ocme_filter_grid', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_filter_grid_condition') ) {
			try {
				Schema::create('ocme_filter_grid_condition', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_filter_property') ) {
			try {
				Schema::create('ocme_filter_property', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_filter_property_value') ) {
			try {
				Schema::create('ocme_filter_property_value', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_filter_property_value_to_product') ) {
			try {
				Schema::create('ocme_filter_property_value_to_product', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('ocme_variable') ) {
			try {
				Schema::create('ocme_variable', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('filter_group_to_store') ) {
			try {
				Schema::create('filter_group_to_store', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('attribute_to_store') ) {
			try {
				Schema::create('attribute_to_store', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('attribute_value_description') ) {
			try {
				Schema::create('attribute_value_description', function( Blueprint $table ){
					$table->engine = 'MyISAM';
		...
		if( ! Schema::hasTable('option_to_store') ) {
			try {
				Schema::create('option_to_store', function( Blueprint $table ){
					$table->engine = 'MyISAM';
