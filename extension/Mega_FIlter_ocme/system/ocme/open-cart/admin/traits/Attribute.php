...
trait Attribute {
	...
	protected function attributeRenderForm( $type = '', array $url_params = array() ) {
		...
		if( $type == 'value' ) {
			...
			$this->data['edit_attribute_action'] = ocme()->url()->adminLink('catalog/attribute/edit', ocme()->model('ocme_mfp')->createUrlParams( 'attribute_id', array( 'attribute_id' => $this->attribute->attribute_id ) ) );
