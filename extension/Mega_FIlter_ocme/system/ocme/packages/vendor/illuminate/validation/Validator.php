...
class Validator
{
    ...
    protected function getMessage($attribute, $rule)
    {
        ...
        $key = "module::validation.{$lowerRule}";
		
        if ($key != ($value = ocme()->trans($key))) {
            return $value;
        }
    ...
    {
        if (($message = ocme()->trans($customKey)) !== $customKey) {
            return $message;
        }
        ...
        $customMessages = Arr::dot(
            (array) ocme()->trans('validation.custom')
        );
    ...
    protected function getSizeMessage($attribute, $rule)
    {
        ...
        $key = "module::validation.{$lowerRule}.{$type}";

        return ocme()->trans($key);
    }
    ...
    public function getDisplayableValue($attribute, $value)
    {
        ...
        $key = "module::validation.values.{$attribute}.{$value}";
