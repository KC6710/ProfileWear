...
class Container extends ContainerPhpDepends implements ContainerContract {
	
	/**
	 * @var string
	 */
	protected $version = '3.0.1.1';
	...
	protected function getDependencies($parameters, array $primitives = array())
	{
		...
		{
			$dependency = ! method_exists( $parameter, 'getType' ) ? $parameter->getClass() : ( $parameter->getType() && !$parameter->getType()->isBuiltin() ? new ReflectionClass($parameter->getType()->getName()) : null );
