...
class MySqlConnector extends Connector implements ConnectorInterface {
	...
	public function connect(array $config)
	{
		...
		} else if (isset($config['modes'])) {
			$connection->prepare("set session sql_mode='".implode(',', $config['modes'])."'")->execute();
		}

		if (isset($config['foreign_key_checks'])) {
			$connection->prepare(sprintf("SET FOREIGN_KEY_CHECKS = %s", $config['foreign_key_checks']))->execute();
		}
