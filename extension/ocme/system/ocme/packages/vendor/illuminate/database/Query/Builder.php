...
class Builder {
	...
	/**
	 * Set the table alias which the query is targeting.
	 *
	 * @param  string  $alias
	 * @return $this
	 */
	...
	/**
	 * Get the table alias which the query is targeting.
	 *
	 * @return string|null
	 */
	public function getFromAlias()
	{
		if (strpos(strtolower($this->from), ' as ') !== false)
		{
	...
	public function where($column, $operator = null, $value = null, $boolean = 'and')
	{
		...
		if ( is_null($operator) || ! in_array(strtolower($operator), $this->operators, true))
		{
			list($value, $operator) = array($operator, '=');
		}
     ...
     * @return \Ocme\Database\Query\Builder|static
     */
    public function whereColumn($first, $operator = null, $second = null, $boolean = 'and')
    {
		...
		{
			throw new InvalidArgumentException("Illegal operator and second combination.");
		}
