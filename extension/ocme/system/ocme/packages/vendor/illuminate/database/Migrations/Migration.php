...
abstract class Migration {
	...
	protected function addDbData() {		
		/* @var $files array */
		if( null != ( $files = glob( ( defined( 'DIR_EXTENSION' ) ? DIR_EXTENSION . 'ocme/system/' : DIR_SYSTEM ) . 'ocme/database/migrations/data/*.json' ) ) ) {
			/* @var $tables array */
			$tables = array(
	...
	protected function removeTables( array $tables ) {
		/* @var $db_changes array */
		$db_changes = (array) ocme()->oc()->registry()->get('config')->get('ocme_mfp_db_changes');
