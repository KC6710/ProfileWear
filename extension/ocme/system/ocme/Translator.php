...
class Translator {
	...
	public function defaultDirectory() {
		if( version_compare( VERSION, '4', '>=' ) ) {
			return ocme()->oc()->registry()->get('config')->get('language_code');
		}
		
		return ocme()->oc()->registry()->get('config')->get('language_directory');
	}
	...
	public function directory() {
		return ocme()->oc()->registry()->get('config')->get('config_language');
	}
