...
class Checkout extends \Opencart\System\Engine\Controller
{
    ...
    public function getCheckoutCountry()
    {
        ...
        if (array_key_exists('language',$this->request->cookie) && $this->request->cookie['language'] == "sv-se") {
            return 203;
        } elseif (array_key_exists('language',$this->request->cookie) && $this->request->cookie['language'] == "nn-no") {
            return 160;
        } elseif (array_key_exists('language',$this->request->cookie) && $this->request->cookie['language'] == "fi-fi") {
            return 72;
        } elseif (array_key_exists('language',$this->request->cookie) && $this->request->cookie['language'] == "da-dk") {
            return 57;
        } elseif (array_key_exists('language',$this->request->cookie) && $this->request->cookie['language'] == "de-de") {
            return 81;
        } else {
    ...
    public function index()
    {
        ...
        //Custom added by Herman Shaho 
        $this->document->setTitle('Kassa - Profilewear.se');
        ...
        $this->response->setOutput($this->load->view('extension/svea/module/svea/checkout', $data));
    }
