...
class SveaCommon extends \Opencart\System\Engine\Controller
{
    ...
    public function addTaxRateToAddons()
    {
        ...
        foreach ($extensions as $extension) {
            ...
            if ($this->config->get($this->totalString . '' . $extension['code'] . '_status')) {
                ...
                $this->load->model('extension/opencart/total/' . $extension['code']);

                ($this->{'model_extension_opencart_total_' . $extension['code']}->getTotal)($totals, $taxes, $total);
