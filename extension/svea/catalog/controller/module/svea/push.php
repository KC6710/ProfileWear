...
class Push extends \Opencart\System\Engine\Controller
{
    ...
    public function index()
    {
        ...
        if ($checkout_order_id != null) {
            ...
            $checkout_entry->setCountryCode($this->model_extension_svea_module_svea_checkout->getCountryCode((int)$checkout_order_id));
