...
namespace Opencart\Admin\Model\Extension\Googleshopping\Module;
...
class Google extends \Opencart\System\Engine\Model {
    private $events = array(
        'admin/view/common/column_left/before' => array(
            'extension/googleshopping/module/google|admin_link',
        ),
        'admin/model/catalog/product/addProduct/after' => array(
            'extension/googleshopping/module/google|addProduct',
        ),
        'admin/model/catalog/product/copyProduct/after' => array(
            'extension/googleshopping/module/google|copyProduct',
        ),
        'admin/model/catalog/product/deleteProduct/after' => array(
            'extension/googleshopping/module/google|deleteProduct',
        ),
        'catalog/controller/checkout/success/before' => array(
            'extension/googleshopping/module/google|before_checkout_success'
        ),
        'catalog/view/common/header/after' => array(
            'extension/googleshopping/module/google|google_global_site_tag'
        ),
        'catalog/view/common/success/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_purchase'
        ),
        'catalog/view/product/product/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_product'
        ),
        'catalog/view/product/search/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_searchresults'
        ),
        'catalog/view/product/category/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_category'
        ),
        'catalog/view/common/home/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_home'
        ),
        'catalog/view/checkout/cart/after' => array(
            'extension/googleshopping/module/google|google_dynamic_remarketing_cart'
        )
    );
    ...
    public function __construct(\Opencart\System\Engine\Registry $registry) {
        ...
        $this->load->model('extension/googleshopping/proxy/event');
    ...
    public function isAnyProductCategoryModified(int $store_id): bool {
    ...
    public function getMapping(int $store_id): array {
    ...
    public function hasActiveTarget(int $store_id): bool {
    ...
    public function deleteProducts(array $product_ids): bool {
    ...
    public function getProductIssues(int $product_id, int $store_id): array|null {
    ...
    private function tableColumnsMatch(string $table, array $columns): bool {
    ...
    private function wrap(array|string $text, string $char): string {
        if (is_array($text)) {
    ...
    public function deleteEvents(): void {
        ...
        $this->model_extension_googleshopping_proxy_event->deleteEventByCode('advertise_google');
    }
    ...
    public function createEvents(): void {
        ...
        foreach ($this->events as $trigger => $actions) {
            foreach ($actions as $action) {
                $this->model_extension_googleshopping_proxy_event->addEvent([
                    'code' => 'advertise_google', 
                    'description' => '',
                    'trigger' => $trigger, 
                    'action' => $action, 
                    'status' => 1, 
