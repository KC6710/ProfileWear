...
class Edit extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['password_save'] = $this->url->link('account/password.save', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token']);
	...
	public function save(): void {
		...
		if (!$json) {
			...
			$json['redirect'] = $this->url->link('account/edit', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'], true);
		}
