...
class Address extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['back'] = $this->url->link('account/edit', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token']);
		...
		$data['column_left'] = $this->load->controller('account/CommonLeft');
		// echo '<pre>';print_r($data['address_form']);die;
	...
	protected function getList(): string {
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = [
				...
				'markdefault'       => $this->url->link('account/address.markdefault', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'] . '&address_id=' . $result['address_id']),
	...
	public function form(): string {
		...
		$data['footer'] = $this->load->controller('common/footer');
		$data['header'] = $this->load->controller('common/header');
		return $this->load->view('account/address_form', $data);
	...
	public function delete(): void {
		...
		if (!$json) {
			...
			$this->response->redirect($this->url->link('account/address', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'], true));
		}
	...
	public function markdefault(): void {
		...
		// Mark Default
		if (isset($this->request->get['address_id'])) {
			$this->model_account_address->markDefaultAddress($this->request->get['address_id']);

			$this->session->data['success'] = $this->language->get('text_mark_default');
			$json['redirect'] = $this->url->link('account/address', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token'], true);
		}
