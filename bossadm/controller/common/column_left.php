...
class ColumnLeft extends \Opencart\System\Engine\Controller
{
	public function index(): string
	{
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string) $this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_order')) {
				$codevoc_quotation[] = [
					'name' => $this->language->get('text_codevoc_order_category'),
					'href' => $this->url->link('codevoc/b2bmanager_order', 'user_token=' . $this->session->data['user_token'].'&filter_order_status_id=1'),
					'children' => []
				];
				
			}
			
			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_quotation')) {
				$codevoc_quotation[] = [
					'name' => $this->language->get('text_codevoc_quotation_category'),
					'href' => $this->url->link('codevoc/b2bmanager_quotation', 'user_token=' . $this->session->data['user_token'].'&filter_quotation_status_id=1&limit=10'),
					'children' => []
				];
			...
			if ($codevoc_quotation) {
				$data['menus'][] = [
					'id' => 'menu-codevoc-quotation',
					'icon' => 'fa fa-calculator fw',
					'name' => $this->language->get('text_codevoc_quotation_main'),
					'href' => '',
					'children' => $codevoc_quotation
				];
			}

			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_purchase')) {
				$data['menus'][] = [
					'id' => 'menu-codevoc-purchase',
					'icon' => 'fa fa-hospital',
					'name' => $this->language->get('text_purchase'),
					'href' => $this->url->link('codevoc/b2bmanager_purchase', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_production')) {
				$data['menus'][] = [
					'id' => 'menu-codevoc-production',
					'icon' => 'fa fa-check-square',
					'name' => $this->language->get('text_production'),
					'href' => $this->url->link('codevoc/b2bmanager_production', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_inventory')) {
				$codevoc_inventory[] = [
					'name' => $this->language->get('text_codevoc_inventory_clothes_category'),
					'href' => $this->url->link('codevoc/b2bmanager_inventory', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'codevoc/b2bmanager_inventoryprint')) {
				$codevoc_inventory[] = [
					'name' => $this->language->get('text_codevoc_inventory_transfer_category'),
					'href' => $this->url->link('codevoc/b2bmanager_inventoryprint', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($codevoc_inventory) {
				$data['menus'][] = [
					'id' => 'menu-codevoc-inventory',
					'icon' => 'fa fa-list fw',
					'name' => $this->language->get('text_codevoc_inventory_main_category'),
					'href' => '',
					'children' => $codevoc_inventory
				];
			}
