...
class Header extends \Opencart\System\Engine\Controller {
	public function index(): string {
		$data['lang'] = $this->language->get('code');
				...
				$data['quoteAction'] = $this->url->link('codevoc/b2bmanager_quotation.gotoQuote', isset($this->session->data['user_token'])? 'user_token=' . $this->session->data['user_token'] : '' , true);
				$data['orderAction'] = $this->url->link('codevoc/b2bmanager_quotation.gotoOrder', isset($this->session->data['user_token'])? 'user_token=' . $this->session->data['user_token'] : '' , true);
