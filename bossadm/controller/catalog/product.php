...
class Product extends \Opencart\System\Engine\Controller {
	...
	public function form(): void {
		...
		// PRODUCT CUSTOM FIELDS -> CONTROLLER
		if (isset($this->request->post['product_customfields'])) {
			$data['product_customfields'] = $this->request->post['product_customfields'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_customfields'] = $this->model_catalog_product->getProductCustomfields($this->request->get['product_id']);
		} else {
			$data['product_customfields'] = array();
		}
		// PRODUCT CUSTOM FIELDS -> CONTROLLER
	...
	// 	$this->load->model('catalog/product');
	// 	$this->model_catalog_product->import();
	// }
}
