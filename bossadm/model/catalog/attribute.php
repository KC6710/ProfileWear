...
class Attribute extends \Opencart\System\Engine\Model {
	...
	// 	// $query = $this->db->query('SELECT * FROM `'. DB_PREFIX .'attribute_pw3`');
	// 	// $i=0;
	// 	// foreach($query->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'attribute` SET `attribute_id`="'.$row['attribute_id'].'", `attribute_group_id`="'.$row['attribute_group_id'].'", `sort_order`="'.$row['sort_order'].'"' )){
	// 	// 		$i++;
	// 	// 	}
	// 	// }
	...
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_desc = $this->db->query('SELECT * FROM `'. DB_PREFIX .'attribute_description_pw3`');
	// 	// $i=0;
	// 	// foreach($query_desc->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'attribute_description` SET 
	// 	// 	`attribute_id`="'.$row['attribute_id'].'", 
	// 	// 	`language_id`="'.$row['language_id'].'", 
	// 	// 	`name`="'.$row['name'].'",
	// 	// 	`tooltip`="'.$row['mf_tooltip'].'"' )){
	// 	// 		$i++;
	// 	// 	}
	// 	// }
	...
	// 	// 	echo "done"; die;
	// 	// }		
	// 	// $query_group = $this->db->query('SELECT * FROM `'. DB_PREFIX .'attribute_group_pw3`');
	// 	// $i=0;
	// 	// foreach($query_group->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'attribute_group` SET 
	// 	// 	`attribute_group_id`="'.$row['attribute_group_id'].'", 
	// 	// 	`sort_order`="'.$row['sort_order'].'"' )){
	// 	// 		$i++;
	// 	// 	}
	// 	// }
	// 	// if($i == count($query_group->rows)){
	// 	// 	echo "done"; die;
	// 	// }	
	// 	$query_group_desc = $this->db->query('SELECT * FROM `'. DB_PREFIX .'attribute_group_description_pw3`');
	// 	$i=0;
	// 	foreach($query_group_desc->rows as $row){
	// 		if($this->db->query('INSERT INTO `'. DB_PREFIX .'attribute_group_description` SET 
	// 		`attribute_group_id`="'.$row['attribute_group_id'].'", 
	// 		`language_id`="'.$row['language_id'].'",
	// 		`name`="'.$row['name'].'"' )){
	// 			$i++;
	// 		}
	// 	}
	// 	if($i == count($query_group_desc->rows)){
	// 		echo "done"; die;
	// 	}	
