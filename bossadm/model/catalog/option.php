...
class Option extends \Opencart\System\Engine\Model {
	...
	// 	// $query = $this->db->query("SELECT * FROM `". DB_PREFIX ."option_pw3`");
	// 	// $i=0;
	// 	// foreach($query->rows as $row){
	// 	// 	$this->db->query('INSERT INTO `'. DB_PREFIX .'option` SET `option_id`="'.$row['option_id'].'", `type`="'.$row['type'].'", `sort_order`= "'.$row['sort_order'].'", `prodoptimgflag`="'.$row['prodoptimgflag'].'"' );
	// 	// 	$i++;
	// 	// }
	// 	// if($i == count($query->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_desc = $this->db->query("SELECT * FROM `". DB_PREFIX ."option_description_pw3`");
	// 	// $i=0;
	// 	// foreach($query_desc->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'option_description` SET `option_id`="'.$row['option_id'].'", `language_id`="'.$row['language_id'].'", `name`= "'.$row['name'].'", `tooltip`="'.$row['mf_tooltip'].'"' )){
	// 	// 		$i++;
	// 	// 	}
	...
	// 	// $query_val = $this->db->query("SELECT * FROM `". DB_PREFIX ."option_value_pw3`");
	// 	// $i=0;
	// 	// foreach($query_val->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'option_value` SET `option_value_id`="'.$row['option_value_id'].'", `option_id`="'.$row['option_id'].'", `image`= "'.$row['image'].'", `sort_order`="'.$row['sort_order'].'", `color`="'.$row['color_code'].'"' )){
	// 	// 		$i++;
	// 	// 	}
			
	// 	// }
	// 	// if($i == count($query_val->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	$query_val_desc = $this->db->query("SELECT * FROM `". DB_PREFIX ."option_value_description_pw3`");
	// 	$i=0;
	// 	foreach($query_val_desc->rows as $row){
	// 		if($this->db->query('INSERT INTO `'. DB_PREFIX .'option_value_description` SET `option_value_id`="'.$row['option_value_id'].'", `language_id`="'.$row['language_id'].'", `option_id`="'.$row['option_id'].'", `name`= "'.$row['name'].'", `pw_custom_color`="'.$row['pw_custom_color'].'"' )){
	// 			$i++;
	// 		}
			
	// 	}
	// 	if($i == count($query_val_desc->rows)){
	// 		echo "done"; die;
	// 	}
	// }
}