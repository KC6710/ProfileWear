...
class Product extends \Opencart\System\Engine\Model {
	public function addProduct(array $data): int {
		...
		$product_id = $this->db->getLastId();
                            ...
                            // PRODUCT CUSTOM FIELDS -> ADD
                            foreach ($data['product_customfields'] as $language_id => $value) {
                                $this->db->query("INSERT INTO " . DB_PREFIX . "product_custom_fields SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', custom_field_attachment = '" . $this->db->escape($value['custom_field_attachment']) . "', custom_field_printable = '" . $this->db->escape($value['custom_field_printable']) . "', replacement_product_id = '" . $this->db->escape($value['replacement_product_id']) . "', replacement_category_id = '" . $this->db->escape($value['replacement_category_id']) . "',product_label = '" . $this->db->escape($value['product_label']) . "'");
                            }
                            // PRODUCT CUSTOM FIELDS -> ADD
	...
	public function copyProduct(int $product_id): void {
		...
		if ($product_info) {
			...
			$this->model_catalog_product->addProduct($product_data);
	                            ...
	                            // PRODUCT CUSTOM FIELDS -> GET
								public function getProductCustomfields($product_id) {
									$product_customfields_data = array();
									$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_custom_fields WHERE product_id = '" . (int)$product_id . "'");
									foreach ($query->rows as $result) {
										$product_customfields_data[$result['language_id']] = array(
											'custom_field_attachment'   => $result['custom_field_attachment'],
											'custom_field_printable'    => $result['custom_field_printable'],
											'replacement_product_id'    => $result['replacement_product_id'],
											'replacement_category_id'   => $result['replacement_category_id'],
											'product_label'             => $result['product_label']
										);
									}
									return $product_customfields_data;
								}
								// PRODUCT CUSTOM FIELDS -> GET
	...
	// 	// $query = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_pw3`');
	// 	// $i=0;
	...
	// 	// 	`sp_auto_select`="'.$row['sp_auto_select'].'",
	// 	// 	`sp_product_sort_order`="'.$row['sp_product_sort_order'].'",
	// 	// 	`sp_substr_start`="'.$row['sp_substr_start'].'",
	// 	// 	`sp_substr_length`="'.$row['sp_substr_length'].'",
	// 	// 	`sp_custom_string`="'.$row['sp_custom_string'].'",
	// 	// 	`sp_leaves_only`="'.$row['sp_leaves_only'].'"' );
	// 	// 	$i++;
	// 	// }
	// 	// if($i == count($query->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_desc = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_description_pw3`');
	// 	// $i=0;
	// 	// foreach($query_desc->rows as $row){

	// 	// 	if($this->db->query("INSERT INTO `". DB_PREFIX ."product_description` SET 
	// 	// 	`product_id`='".$row['product_id']."',
	// 	// 	`language_id`='".$row['language_id']."',
	// 	// 	`name`='".$this->db->escape($row['name'])."',
	// 	// 	`title_tag`='".$this->db->escape($row['title_tag'])."',
	// 	// 	`alt_tag`='".$this->db->escape($row['alt_tag'])."',
	...
	// 	// }
	// 	// if($i == count($query_desc->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_attr = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_attribute_pw3`');
	// 	// $i=0;
	// 	// foreach($query_attr->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_attribute` SET 
	// 	// 	`product_id`="'.$row['product_id'].'",
	...
	// 	// }
	// 	// if($i == count($query_attr->rows)){
	// 	// 	echo "done"; die;
	// 	// }

	// 	// $query_cate = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_to_category_pw3`');
	// 	// $i=0;
	// 	// foreach($query_cate->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_to_category` SET 
	// 	// 	`product_id`="'.$row['product_id'].'",
	...
	// 	// }
	// 	// if($i == count($query_cate->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_image = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_image_pw3`');
	// 	// $i=0;
	// 	// foreach($query_image->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_image` SET 
	...
	// 	// }
	// 	// if($i == count($query_image->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_discount = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_discount_pw3`');
	// 	// $i=0;
	// 	// foreach($query_discount->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_discount` SET 
	...
	// 	// }
	// 	// if($i == count($query_discount->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_option = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_option_pw3`');
	// 	// $i=0;
	// 	// foreach($query_option->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_option` SET 
	...
	// 	// }
	// 	// if($i == count($query_option->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_option_value = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_option_value_pw3`');
	// 	// $i=0;
	// 	// foreach($query_option_value->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_option_value` SET 
	// 	// 	`product_option_value_id`="'.$row['product_option_value_id'].'",
	// 	// 	`product_option_id`="'.$row['product_option_id'].'",
	// 	// 	`product_id`="'.$row['product_id'].'",
	// 	// 	`option_id`="'.$row['option_id'].'",
	// 	// 	`option_value_id`="'.$row['option_value_id'].'",
	// 	// 	`image`="'.$row['prodoptimg'].'",
	// 	// 	`quantity`="'.$row['quantity'].'",
	// 	// 	`subtract`="'.$row['subtract'].'",
	// 	// 	`price`="'.$row['price'].'",
	...
	// 	// 	`prodoptimg_color`="'.$row['prodoptimg_color'].'"' )){
	// 	// 		$i++;
	// 	// 	}
			
	// 	// }
	// 	// if($i == count($query_option_value->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_related = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_related_pw3`');
	// 	// $i=0;
	// 	// foreach($query_related->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_related` SET 
	// 	// 	`product_id`="'.$row['product_id'].'",
	...
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_reward = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_reward_pw3`');
	// 	// $i=0;
	// 	// foreach($query_reward->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_reward` SET 
	...
	// 	// }
	// 	// if($i == count($query_reward->rows)){
	// 	// 	echo "done"; die;
	// 	// }
	// 	// $query_reward = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_to_store_pw3`');
	// 	// $i=0;
	// 	// foreach($query_reward->rows as $row){
	// 	// 	if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_to_store` SET 
	// 	// 	`product_id`="'.$row['product_id'].'",
	...
	// 	// 	echo "done"; die;
	// 	// }
	// 	$query_layout = $this->db->query('SELECT * FROM `'. DB_PREFIX .'product_to_layout_pw3`');
	// 	$i=0;
	// 	foreach($query_layout->rows as $row){
	// 		if($this->db->query('INSERT INTO `'. DB_PREFIX .'product_to_layout` SET 
	// 		`product_id`="'.$row['product_id'].'",
	// 		`store_id`="'.$row['store_id'].'",
