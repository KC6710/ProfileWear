<?php
                            ...
                            // PRODUCT CUSTOM FIELDS -> LANG
                            $_['entry_custom_fields']  = 'Custom Fields';
                            $_['entry_custom_field_attachment']  = 'Attachment URL';
                            $_['entry_custom_field_attachment_help']  = 'Direct URL to patch https://site.se/sizechart.pdf';
                            $_['entry_custom_field_printable']  = 'Printable article';
                            $_['entry_custom_field_printable_help']  = 'Set 1 = Yes / 2 = No';
                            $_['entry_replacement_product_id']  = 'Replacement article';
                            $_['entry_replacement_product_id_help']  = 'Product id';
                            $_['entry_replacement_category_id']  = 'Replacement category';
                            $_['entry_replacement_category_id_help']  = 'Category id';
                            $_['entry_product_label']  = 'Product label';
                            $_['entry_product_label_help']  = 'Shows in categories and search results as a label';
                            // PRODUCT CUSTOM FIELD -> LANG
